...
type Daerah struct {
	...
	WilayahID  uint    `json:"wilayahID" gorm:"type:bigint;not null"`               // Foreign Key untuk Wilayah (ID wilayah)
	Wilayah    Wilayah `json:"wilayah" gorm:"foreignKey:WilayahID"`                 // Relasi ke Wilayah
}
